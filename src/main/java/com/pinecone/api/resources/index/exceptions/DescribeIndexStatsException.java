package com.pinecone.api.resources.index.exceptions;
...
@JsonDeserialize(
    using = DescribeIndexStatsException.Deserializer.class
)
public final class DescribeIndexStatsException extends Exception {
  private final Value value;

  private int statusCode;

  private DescribeIndexStatsException(Value value, int statusCode) {
    this.value = value;
  ...
  public static DescribeIndexStatsException other(Object unknownValue, int statusCode) {
    return new DescribeIndexStatsException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "DescribeIndexStatsException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<DescribeIndexStatsException> {
    @Override
    public DescribeIndexStatsException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new DescribeIndexStatsException(value, statusCode);
    }
  }
}
