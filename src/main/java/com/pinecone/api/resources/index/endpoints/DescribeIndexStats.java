...
public final class DescribeIndexStats {
  private DescribeIndexStats() {
  }

  public static final class Request {
    private final DescribeIndexStatsRequest body;

    private final Optional<ApiKey> authOverride;

    private int _cachedHashCode;

    Request(DescribeIndexStatsRequest body, Optional<ApiKey> authOverride) {
      this.body = body;
      this.authOverride = authOverride;
    }

    public DescribeIndexStatsRequest getBody() {
      return body;
    }
    ...
    public String toString() {
      return "DescribeIndexStats.Request{" + "body: " + body + ", authOverride: " + authOverride + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(DescribeIndexStatsRequest body);
    ...
    public static final class Builder implements BodyStage, _FinalStage {
      private DescribeIndexStatsRequest body;
      ...
      @Override
      public _FinalStage body(DescribeIndexStatsRequest body) {
        this.body = body;
        return this;
      }
