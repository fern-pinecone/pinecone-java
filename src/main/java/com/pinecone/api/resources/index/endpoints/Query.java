...
public final class Query {
  ...
  public static final class Request {
    private final QueryRequest body;

    private final Optional<ApiKey> authOverride;

    private int _cachedHashCode;

    Request(QueryRequest body, Optional<ApiKey> authOverride) {
      this.body = body;
    ...
    public String toString() {
      return "Query.Request{" + "body: " + body + ", authOverride: " + authOverride + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(QueryRequest body);
    ...
    public static final class Builder implements BodyStage, _FinalStage {
      ...
      @Override
      public _FinalStage body(QueryRequest body) {
        this.body = body;
        return this;
      }
